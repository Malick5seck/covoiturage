...
function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="p-2 rounded-xl transition hover:bg-gray-100 dark:hover:bg-gray-700 shrink-0"
    >
      {isDark ? (
        /* Soleil */
        <svg className="w-5 h-5 text-gainde-yellow" viewBox="0 0 24 24" fill="none"
...
function Navbar() {
  ...
  const isActive = (path) =>
    location.pathname === path
      ? 'text-gainde-dark bg-gray-100 dark:text-white dark:bg-gray-700'
      : 'text-gray-500 hover:text-gainde-dark hover:bg-gray-50 dark:text-gray-300 dark:hover:text-white dark:hover:bg-gray-700';
