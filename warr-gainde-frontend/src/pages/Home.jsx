...
function Home() {
  ...
  // SOLUTION TEMPORAIRE : On définit isDriver à false par défaut
  // Plus tard, on récupérera cette info depuis ton AuthContext ou localStorage
      ...
      <div className="max-w-7xl mx-auto py-20 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 text-center hover:-translate-y-2 transition duration-300">
            ...
            <p className="text-gray-500">Tous nos conducteurs sont enregistrés et évalués par la communauté.</p>
          </div>
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 text-center hover:-translate-y-2 transition duration-300">
            <div className="text-5xl mb-4">💸</div>
            <h3 className="text-xl font-bold text-gainde-dark mb-3">Économique</h3>
            <p className="text-gray-500">Partagez les frais de route avec des prix transparents.</p>
          </div>
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 text-center hover:-translate-y-2 transition duration-300">
            <div className="text-5xl mb-4">📱</div>
            <h3 className="text-xl font-bold text-gainde-dark mb-3">100% Mobile</h3>
            <p className="text-gray-500">Gérez vos réservations via WhatsApp et payez facilement.</p>
          </div>
        </div>
      </div>
      ...
      {!isDriver && (
        <div className="max-w-5xl mx-auto px-4 mb-20">
          <div className="bg-gainde-dark rounded-3xl p-10 md:p-16 flex flex-col md:flex-row items-center justify-between shadow-2xl">
            ...
            <Link to="/register?role=driver" className="bg-white text-gainde-dark px-8 py-4 rounded-2xl font-black text-lg hover:bg-gray-100 transition whitespace-nowrap">
              Devenir chauffeur
            </Link>
          </div>
        </div>
